...
def get_car_catalog_info(catalog_directory: tuple) -> None:
    catalog_top_intends = '______________________________' \
                          'CATALOG OF CARS______________________________'
...
def get_dummy_models(brands: tuple) -> tuple:
    ...
    model2 = Model(name='3',
                   technical_description='Electric Car',
                   brand_info=brand1)
    model3 = Model(name='Camry',
                   technical_description='Diesel',
                   brand_info=brand2)
    model4 = Model(name='Corolla',
                   technical_description='Gasoline',
                   brand_info=brand2)
