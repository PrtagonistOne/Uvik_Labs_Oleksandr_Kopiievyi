...
from endpoints.car_endpoints import get_car_catalog_info, \
                                    get_dummy_brands, \
                                    get_dummy_models, \
                                    get_dummy_cars
from endpoints.client_endpoints import get_client_rent_info,\
                                       get_dummy_client_data
...
days_to_rent = 3
get_client_rent_info(client=dummy_client,
                     car=available_dummy_cars[0],
                     days=days_to_rent)
